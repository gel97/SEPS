...
export class PowerSystemComponent implements OnInit {
  ...
  Services:any=[];
    ...
    Add_services(){
      this.toValidate.name = this.power.name == "" || this.power.name== null ? true : false;
      this.toValidate.serviceArea= this.power.serviceArea== "" || this.power.serviceArea == undefined ? true : false;
      this.toValidate.brgyId = this.power.brgyId == "" || this.power.brgyId == undefined ? true : false;
  ...
  Update_services(){
    ...
    this.power.latitude = this.gmapComponent.markers.lat;
      this.service. Update_Services(this.power).subscribe({next:(_data)=>{
        this.List_services();
