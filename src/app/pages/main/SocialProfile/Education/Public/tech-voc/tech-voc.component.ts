...
@Component({
  selector: 'app-tech-voc',
  templateUrl: './tech-voc.component.html',
  styleUrls: ['./tech-voc.component.css'],
})
export class TechVocComponent implements OnInit {
  menuId: string = '6';
  ...
  AddSchool() {
    ...
    this.toValidate.teacherNo =
      this.school.teacherNo == '' || this.school.teacherNo == null
        ? true
        : false;
    this.toValidate.classroomNo =
      this.school.classroomNo == '' || this.school.classroomNo == null
        ? true
        : false;
    this.toValidate.classesNo =
      this.school.classesNo == '' || this.school.classesNo == null
        ? true
        : false;
    this.toValidate.brgyId =
      this.school.brgyId == '' || this.school.brgyId == null ? true : false;
    this.toValidate.enrollyNo =
      this.school.enrollyNo == '' || this.school.enrollyNo == null
        ? true
        : false;
