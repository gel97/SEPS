...
export class MalnutritionRevisedComponent implements OnInit {
  ...
  GetHealthMalnutrition() {
    this.Service.GetHealthMalnutrition(
      this.setYear,
      this.munCityId
    ).subscribe((response) => {
  ...
  AddHealthMalnutrition() {
    ...
    if (
      ...
      this.Service.AddHealthMalnutrition(this.addData).subscribe((request) => {
        if (!this.isCheck) {
  ...
  EditHealthMalnutrition() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.Service.EditHealthMalnutrition(this.addData).subscribe((request) => {
  ...
  DeleteHealthMalnutrition(dataItem: any) {
    Swal.fire({
      title: 'Are you sure?',
      ...
      if (result.isConfirmed) {
        this.Service.DeleteHealthMalnutrition(dataItem.transId).subscribe(
          (request) => {}
        );
