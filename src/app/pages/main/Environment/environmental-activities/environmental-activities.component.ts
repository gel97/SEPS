...
export class EnvironmentalActivitiesComponent implements OnInit {
  ...
  constructor(private Auth: AuthService, private Service: EnvironmentActService) { }
  ...
  GetEnvironmentalActivities() {
    this.Service.GetEnvironmentalActivities(this.setYear, this.munCityId).subscribe(response => {
  ...
  AddEnvironmentalActivities() {
    ...
    if (JSON.stringify(this.dummy_addData) != JSON.stringify(this.dummyData) && this.addData.brgyId != undefined) {
      ...
      this.Service.AddEnvironmentalActivities(this.addData).subscribe(request => {
        if (!this.isCheck) {
  ...
  EditEnvironmentalActivities() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.Service.EditEnvironmentalActivities(this.addData).subscribe(request => {
  ...
  DeleteEnvironmentalActivities(dataItem: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.Service.DeleteEnvironmentalActivities(dataItem.transId).subscribe(request => {
          this.GetEnvironmentalActivities();
        })
        Swal.fire(
          'Deleted!',
