...
UpdateSummary_Estab(){
  ...
  this.toValidate.type = this.editmodal.type =="" || this.editmodal.type == undefined?true:false;
  this.toValidate.count = this.editmodal.count =="" || this.editmodal.count == undefined?true:false;
  // this.toValidate.remarks = this.summ.remarks =="" || this.summ.remarks == null?true:false;
...
delete(transId:any, index:any){
  ...
  get filteredItems() {
    return this.list_of_Business.filter(item => item.categoryId == this.summ.category);
  }
