...
get filteredItems() {
  return this.list_of_Business.filter(item => item.categoryId == this.comm.category);
}
...
Add_Com_Estab(){
  ...
  this.toValidate.lineBusiness = this.comm.lineBusiness =="" || this.comm.lineBusiness == undefined?true:false;
  this.toValidate.owner = this.comm.owner =="" || this.comm.owner == undefined?true:false;


  if (this.toValidate.brgyId == true||this.toValidate.permitNo ==true || this.toValidate.estab == true || this.toValidate.category == true
    ||this.toValidate.status== true || this.toValidate.lineBusiness == true || this.toValidate.owner){
    Swal.fire(
      'Missing Data!',
...
UpdateCommercial(){
  ...
  this.toValidate.permitNo = this.editmodal.permitNo =="" || this.editmodal.permitNo == undefined?true:false;
  this.toValidate.estabName = this.editmodal.estabName =="" || this.editmodal.estabName == undefined?true:false;
  this.toValidate.category = this.editmodal.category =="" || this.editmodal.category == undefined?true:false;
  this.toValidate.status = this.editmodal.status =="" || this.editmodal.status == undefined?true:false;
  this.toValidate.lineBusiness = this.editmodal.lineBusiness =="" || this.editmodal.lineBusiness == undefined?true:false;
  this.toValidate.owner = this.editmodal.owner =="" || this.editmodal.owner == undefined?true:false;


  if (this.toValidate.brgyId == true||this.toValidate.permitNo ==true || this.toValidate.estab == true || this.toValidate.category == true
    ||this.toValidate.status== true || this.toValidate.lineBusiness == true  || this.toValidate.owner == true){
    Swal.fire(
      'Missing Data!',
      'Please fill out the required fields',
      'warning'
...
delete(transId:any, index:any){
  ...
  list_of_Business = [
    ...
    { id: 2, name_business: "Agricultural Equipment And Supplies", categoryId: 1 },
    ...
    { id: 14, name_business: "Banana Tissue Culture Propagator", categoryId: 1 },
    { id: 15, name_business: "Copra Trader", categoryId: 1 },
    { id: 16, name_business: "Banana Exporter", categoryId: 1 },

    { id: 17, name_business: "Bakeshop, bread products retailers", categoryId: 2 },
    { id: 18, name_business: "Cakes, candies  chocolates and pastries retailers", categoryId: 2 },
    { id: 19, name_business: "Carinderias/Eateries/ Barbeque house", categoryId: 2 },
    ...
    { id: 26, name_business: "Ice cream/Frozen products retailers", categoryId: 2 },
    { id: 27, name_business: "KTV/ Restobar/Disco Bar", categoryId: 2 },
    { id: 28, name_business: "Lechon (manok, baka, baboy) retailers", categoryId: 2 },
    { id: 29, name_business: "Liquors and Beverages delivery services", categoryId: 2 },
    { id: 30, name_business: "Meatshop/ dressed chicken retailers", categoryId: 2 },
    { id: 31, name_business: "Peddlers/ Packed meals and beverages", categoryId: 2 },
    { id: 32, name_business: "Pizza Parlors", categoryId: 2 },
    { id: 33, name_business: "Processed food/ processed meat retailers", categoryId: 2 },
    ...
    { id: 37, name_business: "Softdrinks and beer wholesalers/ retailers", categoryId: 2 },
    { id: 38, name_business: "Vegetable vendors", categoryId: 2 },
    { id: 39, name_business: "Water Filling Stations", categoryId: 2 },
    { id: 40, name_business: "Food Processors (Cassava, banana, etc.)", categoryId: 2 },

    { id: 41, name_business: "Acetylene/ Oxygen/ Industrial gas dealers", categoryId: 3 },
    ...
    { id: 48, name_business: "Firearms/  ammo dealers/ retailers", categoryId: 3 },
    ...
    { id: 57, name_business: "Junkshops /Scrap materials buy and sell", categoryId: 3 },
    ...
    { id: 68, name_business: "Auto Supply/ Car and Jeep Parts and accesories", categoryId: 4 },
    { id: 69, name_business: "Auto detailing services/ upholstery", categoryId: 4 },
    { id: 70, name_business: "Auto-repair shops", categoryId: 4 },
    { id: 71, name_business: "Car wash services", categoryId: 4 },
    { id: 72, name_business: "Fabrication/ Machine shops/Calibration Services", categoryId: 4 },
    ...
    { id: 77, name_business: "Motorcycle/Bicycle Parts And Supplies", categoryId: 4 },
    ...
    { id: 86, name_business: "Beauty Parlor/Barber Shop/ Facial and body care salons", categoryId: 5 },
    { id: 87, name_business: "Bags And Footwear Store", categoryId: 5 },
    { id: 88, name_business: "Balloons And Party Needs", categoryId: 5 },
    { id: 89, name_business: "Beauty products and accessories retailers", categoryId: 5 },
    { id: 90, name_business: "Flower Shop", categoryId: 5 },
    { id: 91, name_business: "Garments/ Upholstery services", categoryId: 5 },
    { id: 92, name_business: "Gift Shops/ Toy retailers/ Bazaars", categoryId: 5 },
    { id: 93, name_business: "Jewelry Shops/store/ repair shops", categoryId: 5 },
    { id: 94, name_business: "Laundry Shop  ", categoryId: 5 },
    { id: 95, name_business: "Music/ entertainment stores and services", categoryId: 5 },
    { id: 96, name_business: "Party/ Wedding planning services", categoryId: 5 },
    { id: 97, name_business: "Perfume retailers", categoryId: 5 },
    { id: 98, name_business: "Prepaid cards retailer/ reloading stations", categoryId: 5 },
    ...
    { id: 112, name_business: "Veterinary Clinic/ products and services", categoryId: 7 },
    ...
    { id: 116, name_business: "Cellphone shops, repairs and accessories", categoryId: 9 },
    { id: 117, name_business: "Computer services and repairs", categoryId: 9 },
    { id: 118, name_business: "Computer shops/ ICT parts sales ", categoryId: 9 },
    ...
    { id: 122, name_business: "Internet shops/ On-line gaming ", categoryId: 9 },
    { id: 123, name_business: "Prepaid cards retailer/ reloading stations ", categoryId: 9 },
    ...
    { id: 145, name_business: "Household maintenance services", categoryId: 11 },
    { id: 146, name_business: "Law Offices/Notary Public", categoryId: 11 },
    { id: 147, name_business: "Manpower services/ Job placement agency", categoryId: 11 },
    { id: 148, name_business: "Marketing services", categoryId: 11 },
    { id: 149, name_business: "Pest control", categoryId: 11 },
    { id: 150, name_business: "Refrigiration/ Aircon/ Appliance repairs", categoryId: 11 },
    ...
    { id: 160, name_business: "Construction contractors/ developers", categoryId: 12 },
    { id: 161, name_business: "Construction Supplies/Concrete Products", categoryId: 12 },
    { id: 162, name_business: "Drilling/ Excavations/ Septic services", categoryId: 12 },
    ...
    { id: 167, name_business: "Home improvement/ Interior Decorating", categoryId: 12 },
    ...
    { id: 172, name_business: "Real estate developers/ brokers", categoryId: 12 },
    ...
    { id: 179, name_business: "Paintings/ Printed arts retailers", categoryId: 13 },
    { id: 180, name_business: "Photo Studio and supplies", categoryId: 13 },
    { id: 181, name_business: "Printing Press/ printing services / publishing", categoryId: 13 },
    { id: 182, name_business: "Signs/ billboards/ advertisement shop", categoryId: 13 },
    ...
    { id: 187, name_business: "Express Mail/  Mailing services", categoryId: 14 },
    ...
    { id: 192, name_business: "Motion pictures production facility", categoryId: 14 },
