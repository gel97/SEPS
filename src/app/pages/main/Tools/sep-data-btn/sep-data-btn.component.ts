...
@Component({
  selector: 'app-sep-data-btn',
  templateUrl: './sep-data-btn.component.html',
  styleUrls: ['./sep-data-btn.component.css']
})
export class SepDataBtnComponent implements OnInit {
  list_muncity:any = {};
  set_year:any;
  muncity_id:any;
  muncity:any =  {};
