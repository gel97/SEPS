...
// SOCIAL-PROFILE
    ...
    post_import_education_schools = (menuId:any)=>`/EducationSchools/Import/${menuId}`;

    // Education TechVoc
    get_list_education_techvoc    = (setYear  :any,munCityId :any)=>`/EducationTechVoc/${setYear}/${munCityId}`;
    ...
    // Education Tertiary
    get_list_education_tertiary    = (setYear  :any,munCityId :any)=>`/EducationTertiary/${setYear}/${munCityId}`;
    ...
    get_list_education_tertiary_grad    = (setYear  :any,munCityId :any)=>`/EducationTertiaryGrad/${setYear}/${munCityId}`;
    get_education_tertiary_grad         = (transId:any,)=>`/EducationTertiaryGrad/${transId}`;
    ...
    get_education_programs_techvoc      = (recNo:any,)=>`/EducationProgramTechVoc/${recNo}`;
    post_education_programs_techvoc     = ()=>`/EducationProgramTechVoc`;
    put_education_programs_techvoc      = ()=>`/EducationProgramTechVoc`;
    delete_education_programs_techvoc   = (recNo:any)=>`/EducationProgramTechVoc/${recNo}`;
    ...
    get_list_safety_fire     = ( setYear  :any,munCityId :any)=>`/SafetyFireProtection/${setYear}/${munCityId}`;
...
//INFRASTRUCTURE & UTILITIES
    ...
    post_import_service_facility = (menuId :any)=>`/ServiceFacilities/Import/${menuId}`;
