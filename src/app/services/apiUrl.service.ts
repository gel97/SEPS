...
export class ApiUrl {
  ...
  //Physical Geo Prof Revise
  get_list_prof = (munCityId: any, setYear: any) =>
    `/PhyisicalGeoProf/${setYear}/${munCityId}`;
  post_save_prof = () => `/PhyisicalGeoProf`;
  put_update_prof = () => `/PhyisicalGeoProf`;
  delete_prof = (transId: any) => `/PhyisicalGeoProf/${transId}`;
