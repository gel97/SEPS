...
export class EnvironmentActService {
  ...
  GetEnvironmentalActivities(setYear: any, munCityId: any) {
    return this.http.get<any[]>(
      this.Base.url +
        this.ApiUrl.get_list_environment_activities(setYear, munCityId),
      { responseType: `json` }
    );
  }
  ...
  AddEnvironmentalActivities(environment: any) {
    return this.http.post<any[]>(
      this.Base.url + this.ApiUrl.post_environment_activities(),
      environment,
      { responseType: 'json' }
    );
  }
  ...
  EditEnvironmentalActivities(environment: any) {
    return this.http.put<any[]>(
      this.Base.url + this.ApiUrl.put_environment_activities(),
      environment,
      { responseType: 'json' }
    );
  }
  ...
  DeleteEnvironmentalActivities(transId: any) {
    return this.http.delete(
      this.Base.url + this.ApiUrl.delete_environment_activities(transId),
      { responseType: 'text' }
    );
  }
  ...
  Import(): Observable<any[]> {
    return this.http.post<any[]>(
      this.Base.url + this.ApiUrl.post_import_EnvAct(),
      { responseType: 'json' }
    );
  }
}
