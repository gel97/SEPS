...
export class AgricultureService {
  ...
  GetListAgriculture(menuId: any, setYear: any, munCityId: any) {
    return this.http.get<any[]>(this.Base.url + this.ApiUrl.get_list_agriculture(menuId, setYear, munCityId), { responseType: `json` });
  }

  AddAgriculture(ricecropsproduction: any) {
    console.log("check_service", ricecropsproduction);
    return this.http.post<any[]>(this.Base.url + this.ApiUrl.post_agriculture(), ricecropsproduction, { responseType: 'json' });
  }

  EditAgriculture(ricecropsproduction: any) {
    console.log("check_service", ricecropsproduction);
    return this.http.put<any[]>(this.Base.url + this.ApiUrl.put_agriculture(), ricecropsproduction, { responseType: 'json' });
  }
