...
List_Facilities(menuId:any,setYear:any,munCityId :any) {
  ...
  Report():Observable<any[]> {
    return this.http.post<any[]>(this.Base.url + this.ApiUrl.post_report_facilities(), { responseType: 'json' });
  }

  Import(menuId :any,):Observable<any[]> {
      return this.http.post<any[]>(this.Base.url + this.ApiUrl.post_import_facilities(menuId), { responseType: 'json' });
  }
