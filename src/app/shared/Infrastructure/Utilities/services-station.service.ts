...
List_Station(menuId:any,setYear:any,munCityId :any) {
  ...
  Report():Observable<any[]> {
    return this.http.post<any[]>(this.Base.url + this.ApiUrl.post_report_station(), { responseType: 'json' });
  }

  Import(menuId :any,):Observable<any[]> {
      return this.http.post<any[]>(this.Base.url + this.ApiUrl.post_import_station(menuId), { responseType: 'json' });
  }
