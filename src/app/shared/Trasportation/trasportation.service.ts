...
export class TrasportationService {
  ...
  get_list_transpo_road():Observable<any[]> {
    ...
    return this.Http.get<any[]>(this.Base.url + this.ApiUrl.get_list_transpo_road(this.Auth.setYear, this.Auth.munCityId), { responseType: 'json' });
  
  }
  post_save_transpo_road(list:any={}) {
    return this.Http.post(this.Base.url + this.ApiUrl.post_save_transpo_road(),list, { responseType: 'json' });
  }
  put_update_transpo_road(list:any={}) {
    return this.Http.put(this.Base.url + this.ApiUrl.put_update_transpo_road(),list, { responseType: 'json' });
  }
  ...
  get_list_transpo_bridge():Observable<any[]> {
    ...
    return this.Http.get<any[]>(this.Base.url + this.ApiUrl.get_list_transpo_bridge(this.Auth.setYear, this.Auth.munCityId), { responseType: 'json' });
  
  }

  post_save_transpo_bridge(list:any={}) {
    return this.Http.post(this.Base.url + this.ApiUrl.post_save_transpo_bridge(),list, { responseType: 'json' });
  }
  put_update_transpo_bridge(list:any={}) {
    return this.Http.put(this.Base.url + this.ApiUrl.put_update_transpo_bridge(),list, { responseType: 'json' });
  }
  ...
  post_save_transpo_terminal(list:any={}) {
    return this.Http.post(this.Base.url + this.ApiUrl.post_save_transpo_terminal(),list, { responseType: 'json' });
  }
  put_update_transpo_terminal(list:any={}) {
    return this.Http.put(this.Base.url + this.ApiUrl.put_update_transpo_terminal(),list, { responseType: 'json' });
  }
